---
title: TrulyRandom Privacy Policy
---
...
To make the App work as expected, TrulyRandom stores certain data locally on your device, such as:

- your saved custom lists and list items
- your app preferences, such as random number settings and team count
- whether you have dismissed introductory helper text
- daily free-tier usage counters
- widget-related settings and cached widget state
- premium unlock state stored locally for access control
...
TrulyRandom does not sell your personal information.

TrulyRandom does not share your data with advertisers, data brokers, or analytics providers through the App itself.

Apple may process information related to App Store purchases, downloads, and device-level services under Apple’s own terms and privacy practices.

## Data Retention

Because most App data is stored locally on your device, it generally remains there until you delete it, remove the App, reset your device, or clear the relevant device storage.
...
TrulyRandom is not intended to knowingly collect personal information from children through the App.

## Changes to This Policy

This Privacy Policy may be updated from time to time. If it changes, the updated version will be made available through the App listing, website, or other published support materials, with a revised effective date.
